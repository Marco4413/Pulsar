...
CPULSAR_API CPulsar_Value CPULSAR_CALL CPulsar_Locals_Get(CPulsar_Locals self, size_t idx);
// Moves `value` into the list at `idx`. `value` must be deleted by its owner
CPULSAR_API void CPULSAR_CALL CPulsar_Locals_Set(CPulsar_Locals self, size_t idx, CPulsar_Value value);
// Copies `value` into the list at `idx`. `value` must be deleted by its owner
CPULSAR_API void CPULSAR_CALL CPulsar_Locals_SetCopy(CPulsar_Locals self, size_t idx, const CPulsar_Value value);
