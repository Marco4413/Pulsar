...
CPULSAR_DEPRECATED("use CPulsar_Stack_Emplace()")
CPULSAR_API CPulsar_Value* CPULSAR_CALL CPulsar_Stack_PushEmpty(CPulsar_Stack* self);

// Returns the top-most value and removes it from `self`, ownership is given to the caller.
...
CPULSAR_API CPulsar_Value* CPULSAR_CALL CPulsar_Stack_Emplace(CPulsar_Stack* self);
...
CPULSAR_API void CPULSAR_CALL CPulsar_Stack_PushCopy(CPulsar_Stack* self, const CPulsar_Value* value);
