...
typedef CPulsar_CustomTypeData_Ref(CPULSAR_CALL *CPulsar_CustomType_DataFactoryFn)(void);
...
CPULSAR_API CPulsar_CBuffer* CPULSAR_CALL CPulsar_CustomTypeData_Ref_GetBuffer(CPulsar_CustomTypeData_Ref self);
CPULSAR_API void             CPULSAR_CALL CPulsar_CustomTypeData_Ref_Delete(CPulsar_CustomTypeData_Ref self);
